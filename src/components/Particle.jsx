    ...
    () => ({
      ...
      interactivity: {
        ...
        modes: {
          ...
          push: { default: true, groups: [], quantity: 10 },
          remove: { quantity: 2 },
          repulse: { distance: 200, duration: 0.4, factor: 100, speed: 1, maxSpeed: 50, easing: "ease-out-quad" },
          ...
          absorbers: {
            ...
            destroy: true,
            orbits: false,
            size: { value: 50, density: 5, limit: { radius: 0, mass: 0 } },
          },
        },
      },
      manualParticles: [],
      particles: {
        ...
        color: {
          value: isDarkMode === "dark" ? "#ffffff" : "#000000",
          animation: {
        ...
        number: { density: { enable: false, width: 1920, height: 1080 }, limit: { mode: "delete", value: 0 }, value: 300 },
        opacity: {
          value: { min: 0.1, max: 1 },
          animation: {
            count: 0,
      ...
      absorbers: {
        ...
        destroy: true,
        orbits: false,
        size: { value: { min: 5, max: 10 }, density: 5, limit: { radius: 10, mass: 0 } },
        position: { x: 50, y: 50 },
      },
